...
func (o *AddOneCreated) WithPayload(payload *models.Cluster) *AddOneCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add one created response
func (o *AddOneCreated) SetPayload(payload *models.Cluster) {
	o.Payload = payload
}
