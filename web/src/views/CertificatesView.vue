...
<template>
  <div>
    ...
    <el-alert v-if="certificateStore.error" :title="certificateStore.error" type="error" show-icon style="margin-bottom: 16px" />
    ...
    <el-dialog
      ...
      :title="isEditing ? 'Edit Certificate' : 'Create Certificate'"
      width="640"
      destroy-on-close
    >
