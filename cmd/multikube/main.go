...
func init() {
	...
	defaultRs256PrivKeyPath := filepath.Join(defaultStatePath, "sign.pem")
	defaultRs256PublKeyPath := filepath.Join(defaultStatePath, "verify.pem")
	...
	pflag.StringVar(&rs256PrivateKey, "rs256-private-key", defaultRs256PrivKeyPath, "the RS256 private key used to sign JWT's")
	pflag.StringVar(&rs256PublicKey, "rs256-public-key", defaultRs256PublKeyPath, "the RS256 public key used to validate the signature of client JWT's")
